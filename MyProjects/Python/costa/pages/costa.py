...
class Costa:
    ...
    def __init__(self, info, email):
        self.college_name = 'Orange Coast College'
        self.path = 'driver/chromedriver.exe'
        self.driver = webdriver.Chrome(executable_path=self.path)
        self.baseURL = 'http://www.orangecoastcollege.edu/enrollment/admissions/Pages/default.aspx'
    ...
    def openccc_apply_page_1(self):
        ...
        self._click_button_by_ID('-have-ssn-yes')
        self._set_input_by_id('-ssn-input1', self.ssn_number)
        self._set_input_by_id('-ssn-input2', self.ssn_number)
    ...
    def account_created_page(self):
        ...
        while waiting:
            try:
                ...
                waiting = True
        self._click_button_by_XPATH('//*[@id="registrationSuccess"]/main/div[2]/div/div/button')
    ...
    def find_apply_button(self):
        try:
            self._click_button_by_XPATH(
                '//*[@id="ctl00_PlaceHolderMain_UIVersionedContent1_RichHtmlField1__ControlWrapper_RichHtmlField"]/p[6]/a/img')
        except NoSuchElementException:
    ...
    def enrollment(self):
        time.sleep(5)
        self.set_select('inputTermId', 'CAP_4526')
        self.set_select('inputEduGoal', 'A')
    ...
    def save_info(self):
        ...
        with open("accountinfo.txt", 'a') as txtFile:
            ...
            txtFile.writelines("EDU mail password ==> {}{}03241997CCCD\n".format(self.firstname[0].upper(),
